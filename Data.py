class Data:
    ...
    class Game:
        ...
        sql_u = {
            "Data": "EXEC dbo.GamesDataManipulate @id = :id, @name = :name, @category = :category, @date = :date, @genre = :genre, @series = :series, @type = 'ADDGAME'"
            ...
            ,
            "Difficulties2": "EXEC dbo.GamesDataManipulate @id = :id, @diff = :diff, @complete = :complete, @ign = :ign, @type = 'ADDDIFF'"
